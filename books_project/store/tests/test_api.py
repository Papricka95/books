...
class BookApiTestCase(APITestCase):
    # конструктор юниттеста
    def setUp(self):
        self.book_1 = Book.objects.create(name='Test book 1', price='25.00', author_name='Author 1')
        self.book_2 = Book.objects.create(name='Test book 2', price='55.00', author_name='Author 5')
        self.book_3 = Book.objects.create(name='Test book Author 1', price='55.00', author_name='Author 2')
